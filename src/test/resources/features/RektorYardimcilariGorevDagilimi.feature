@rektoryardimcilarigorev
  Feature: Rektor Yardimcilari Gorev Dagilimi
    Scenario:
    ...
    Scenario:
      ...
      Then user should see Tanitim Katologu1 Page

    Scenario:
      Given user on the Rektor Yardimcilari Gorev Dagilimi Page
      When user click on Universite Button
      When user click on Tanitim Page Button
      Then user should see Tanitim Katologu2 Page
    ...
    Scenario:
      ...
      Then user should see Enstitüler Title: "Enstitüler" on Rektor Yardimcilari Gorev Dagilimi Page
      Then user should see Enstitüler Title: "Merkezler" on Rektor Yardimcilari Gorev Dagilimi Page
      Then user should see Enstitüler Title: "UNESCO Kürsülerimiz" on Rektor Yardimcilari Gorev Dagilimi Page
      Then user should see Enstitüler Title: "Fakülteler" on Rektor Yardimcilari Gorev Dagilimi Page
      Then user should see Enstitüler Title: "Konservatuvar" on Rektor Yardimcilari Gorev Dagilimi Page
      Then user should see Enstitüler Title: "Yüksekokullar" on Rektor Yardimcilari Gorev Dagilimi Page
      Then user should see Enstitüler Title: "Meslek Yüksekokulları" on Rektor Yardimcilari Gorev Dagilimi Page
